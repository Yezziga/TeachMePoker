...
public class Ai {
	...
	public void setStartingHand(Card card1, Card card2) { // set starting hand
		...
		aiHand.clear(); // resets the arraylist.
		tableCards.clear(); // resets the arraylist.
	...
	public int getFirstCardNumber() {
		return aiHand.get(0).getCardValue();
	}

	public String getFirstCardLetter() {
		return aiHand.get(0).getCardSuit();
	}

	public int getSecondCardNumber() {
		return aiHand.get(1).getCardValue();
	}

	public String getSecondCardLetter() {
		return aiHand.get(1).getCardSuit();
	}

	public ArrayList<Card> getWinningCards(){
		return aiDecide.getWinningCards();
	}

	public ArrayList<Card> getAIHand(){
		return aiDecide.getAIHand();
	}
	
	public ArrayList<Card> getAllCards(){
		return aiDecide.getAllCards();
	}
	...
	public void makeDecision(int currentBet) {
		...
		aiDecide = new AiDecide(aiHand, tableCards, aiPot, currentBet, paidThisTurn, sameTurn);
